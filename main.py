...
def main():
    ...
    dispatcher.add_handler(CommandHandler("search", search_and_download))
    dispatcher.add_handler(CommandHandler("findfree", find_free_files))
    dispatcher.add_handler(CommandHandler("All", All))
    dispatcher.add_handler(CommandHandler('stop', stop_search))
